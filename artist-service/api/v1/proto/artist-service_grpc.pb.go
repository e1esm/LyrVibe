...
const (
	...
	ArtistService_AddAlbum_FullMethodName    = "/artist.api.v1.proto.ArtistService/AddAlbum"
)
...
type ArtistServiceClient interface {
	...
	AddAlbum(ctx context.Context, in *NewAlbumRequest, opts ...grpc.CallOption) (*NewAlbumResponse, error)
}
...
func (c *artistServiceClient) AddAlbum(ctx context.Context, in *NewAlbumRequest, opts ...grpc.CallOption) (*NewAlbumResponse, error) {
	out := new(NewAlbumResponse)
	err := c.cc.Invoke(ctx, ArtistService_AddAlbum_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ArtistServiceServer interface {
	...
	AddAlbum(context.Context, *NewAlbumRequest) (*NewAlbumResponse, error)
...
func (UnimplementedArtistServiceServer) AddAlbum(context.Context, *NewAlbumRequest) (*NewAlbumResponse, error) {
...
func _ArtistService_AddAlbum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewAlbumRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ArtistServiceServer).AddAlbum(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ArtistService_AddAlbum_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArtistServiceServer).AddAlbum(ctx, req.(*NewAlbumRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ArtistService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddAlbum",
			Handler:    _ArtistService_AddAlbum_Handler,
		},
	},
